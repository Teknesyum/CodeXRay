...
const evidenceByPrefix: Record<string, string[]> = {
  ...
  'REQ-AGENT': ['src/services/titanEngine.test.ts', 'e2e/god-mode-failures.spec.ts'],
  ...
  'REQ-TXN': ['src/context/TimelineContext.titanMode.test.tsx', 'e2e/god-mode-failures.spec.ts'],
