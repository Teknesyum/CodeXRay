...
| 10 | Root and per-folder `CLAUDE.md` routers current | closed | Root `CLAUDE.md` plus `e2e/CLAUDE.md`, `docs/titan/CLAUDE.md`, `src/services/titan/CLAUDE.md`, and `src/services/trace/CLAUDE.md`; each sibling router contains exactly `@AGENTS.md`. | H04 |
