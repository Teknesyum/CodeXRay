...
Bu belge geliştirme başlamadan önce Serkan tarafından okunmalıdır. Anlaşılmayan,
...
Serkan release öncesinde aşağıdaki işlemleri tek browser profilinde tamamlar:
...
Serkan yalnızca bütün zorunlu alanları gördükten sonra aşağıdaki ifadeyi
onaylamalıdır:
