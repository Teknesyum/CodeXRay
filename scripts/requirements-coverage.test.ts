...
const evidenceByPrefix: Record<string, string[]> = {
  ...
  'REQ-AGENT': ['src/services/godModeOrchestrator.test.ts', 'e2e/god-mode-failures.spec.ts'],
  ...
  'REQ-CODE': ['src/services/simLang.test.ts', 'e2e/interval-dp-god-mode.spec.ts'],
  ...
  'REQ-ROUTE': ['src/services/godModeRouting.test.ts', 'e2e/ai-routing-interruption.spec.ts'],
  ...
  'REQ-TUTOR': ['src/services/teachingPlan.test.ts', 'e2e/interval-dp-god-mode.spec.ts'],
  'REQ-TXN': ['src/context/TimelineContext.godMode.test.tsx', 'e2e/god-mode-failures.spec.ts'],
  'REQ-UI': ['src/services/godModeRouting.test.ts', 'e2e/responsive-layout.spec.ts'],
  ...
  'GM-INT': ['src/services/gm2Contracts.test.ts', 'src/services/godModeOrchestrator.test.ts'],
  'GM-PERF': ['src/test/progressWatchdog.test.ts', 'scripts/check-build-size.mjs'],
  'GM-PERSIST': ['src/context/TimelineContext.godMode.test.tsx', 'src/services/siteReset.test.ts'],
